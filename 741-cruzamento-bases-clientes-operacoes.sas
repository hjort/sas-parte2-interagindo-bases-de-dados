...
PROC CONTENTS data=alura.operacoes_201709 varnum;
RUN;

PROC CONTENTS data=alura.cadastro_cliente_v3 varnum;
RUN;
...
PROC PRINT data=cad_cli_jogos;
RUN;
PROC PRINT data=contratos_cpf;
RUN;